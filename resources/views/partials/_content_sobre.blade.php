<section id="sobre" class="gray-section" style="padding-top:50px; padding-bottom:50px;">
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <h1>Sobre a <b>ferramenta</b></h1>
                <p style="color:#424242">Conheça um pouco da nossa <b>trajetória</b></p>
            </div>
        </div>
        <div class="row features-block">
            <div class="col-lg-6 features-text wow fadeInLeft animated" style="visibility: visible; animation-name: fadeInLeft;">
                ...
                <ul class="list-inline social-icon" style="margin-top:25px;">
                    ...
                    <li><a href="#"><i class="fa fa-dropbox"></i></a>
                    </li>
                </ul>
            </div>
            <div class="col-lg-6 text-right wow fadeInRight animated" style="visibility: visible; animation-name: fadeInRight;">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/XkNHB0A0JDo" frameborder="0" allowfullscreen></iframe>
